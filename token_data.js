...
tdata.header_teen = {
    ...
    spa:"Registro Para Tarjetas de la Biblioteca Para Adolescentes",
    chi:"青少年圖書証申請表"
};
tdata.header_child = {
...
tdata.pickup_note_adult = {
    ...
    spa:"Recoja su tarjeta de la biblioteca en persona en su sucursal más cercano en los próximos 14 días y traiga los siguientes documentos:<ol><li>Identificación fotográfica</li><li>Prueba de su dirección actual</li></ol>",
...
tdata.pickup_note_teen = {
    ...
    chi:"請在填寫表格後十四日內，帶同附有照片的身份証到附近圖書館分館領取你的圖書証。若不能提供身份証明文件，請填寫由家長/法定監護人簽名的<a href=\"http://www.oaklandlibrary.org/sites/default/files/uploads/OPL_Card_App_Eng_Teens_0.pdf\">書面申請表格</a>。"
};
tdata.pickup_note_child = {
    ...
    chi:"家長/法定監護人和孩子在填寫申請表格後十四日內，必須一同前往圖書館領取孩子的圖書証。家長/法定監護人亦可預先填寫<a href=\"http://www.oaklandlibrary.org/sites/default/files/uploads/OPL_Card_App_Eng_Kids_0.pdf\">書面申請表格</a>，讓孩子在沒有家表的陪同下仍可辨理申請手續。"
};
tdata.required = {
    eng:"required field",
...
tdata.error_agreement_box = {
    ...
    spa:"Se requiere que lea y este de acuerdo con los término de la biblioteca antes de someter su solicitud.",
...
tdata.confirm = {
    ...
    spa:"Confirmación de su Registro en Línea",
    chi:"網上登記確認"
};
tdata.date_registered = {
    eng:"Date registered:",
    spa:"Fecha del registro:",
    chi:"登記日期:"
};
tdata.thanks = {
    eng:"Thanks for registering!",
    spa:"¡Gracias! por registrase",
    chi:"謝謝你的申請!"
};
tdata.confirm_note = {
    ...
    chi:"<p>請<strong>打印此確認​</ strong>，在填寫表格後十四日內，帶同以下文件到附近圖書館分館領取你的圖書証：</ p><ul> <li>附有照片的身份證</li> <li>地址證明</li></ ul><p>13歲以下兒童，父母/法定監護人和孩子都必須親身領取孩子的圖書証</p>"
};
tdata.button_print = {
    eng:"Print Confirmation",
    spa:"Imprima su Confirmación",
    chi:"打印確認"
};
tdata.button_close = {
    eng:"Close / Cerar / 關閉",
